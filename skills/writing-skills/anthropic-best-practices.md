...
For reference-file casing, either ALL_CAPS names like `FORMS.md`, `REFERENCE.md`, and `EXAMPLES.md` or lowercase names like `finance.md`, `sales.md`, `product.md`, and `marketing.md` can work. Pick one convention per Skill for consistency; as a practical default, prefer lowercase for content-specific files and reserve ALL_CAPS for global reference lists or shared guides.

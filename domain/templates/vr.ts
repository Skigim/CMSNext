...
// ============================================================================
// Deprecated Utilities (kept for backwards compatibility)
// ============================================================================
...
export function getPlaceholdersByCategory(): Record<
  string,
  Array<{ field: TemplatePlaceholderField; label: string }>
> {
  ...
  for (const [field, config] of Object.entries(TEMPLATE_PLACEHOLDER_FIELDS)) {
    ...
    grouped[fieldCategory].push({
      field: field as TemplatePlaceholderField,
      label,
    });
  }
 ...
 */
export function createDefaultVRScript(
  name: string,

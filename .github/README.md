...
| `agents/*.agent.md`              | Focused custom agents for audit, frontend, domain, hooks, services, storage, and testing work |
...
- `agents/*.agent.md` are reserved for focused personas with explicit tool scopes.
...
- `copilot-instructions.md` also defines when the default agent should automatically delegate to `audit`, `frontend`, `domain`, `hooks`, `services`, `storage`, `testing`, or `Explore` based on task type.
